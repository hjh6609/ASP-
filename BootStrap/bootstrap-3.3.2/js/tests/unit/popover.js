$(function () {
  ...
  test('should get title and content from options', function () {
    var $popover = $('<a href="#">@fat</a>')
      ...
      .bootstrapPopover({
        ...
        content: function () {
          return 'loves writing tests Ôºà‚ïØ¬∞?°¬∞Ôºâ??∏µ ?ª‚îÅ??
        }
      })
    ...
    equal($('.popover .popover-content').text(), 'loves writing tests Ôºà‚ïØ¬∞?°¬∞Ôºâ??∏µ ?ª‚îÅ??, 'content correctly inserted')
  ...
  test('should not duplicate HTML object', function () {
    var $div = $('<div/>').html('loves writing tests Ôºà‚ïØ¬∞?°¬∞Ôºâ??∏µ ?ª‚îÅ??)
  ...
  test('should get title and content from attributes', function () {
    var $popover = $('<a href="#" title="@mdo" data-content="loves data attributes (?•ÔΩ°?ï‚Äø‚Äø‚óïÔΩ???Ô∏??ª‚îÅ?? >@mdo</a>')
      .appendTo('#qunit-fixture')
      .bootstrapPopover()
      .bootstrapPopover('show')
    ...
    equal($('.popover .popover-content').text(), 'loves data attributes (?•ÔΩ°?ï‚Äø‚Äø‚óïÔΩ???Ô∏??ª‚îÅ??, 'content correctly inserted')
