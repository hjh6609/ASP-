...
<%
	Class clsDBHelper
		...
		private sub Class_Initialize()
			DefaultConnString = "Provider=SQLOLEDB;Data Sourc<P>e=(local);Initial Catalog=testDB;User ID=computer;Password=qlalfqjsgh!@#4;"
    ...
    Public Function ExecSPReturnRS(spName, params, connectionString)
		'response.write params(1)(1)
		'response.write UBound(params)+1
		'response.End 
    ...
    Public Function ExecSQLReturnRS(strSQL, params, connectionString)
		...
		'response.write "</br>ggg23355888899"
		'response.End 
      If IsObject(connectionString) Then
        If connectionString is Nothing Then
          If DefaultConnection is Nothing Then
		    ...
		    For i = LBound(params) To UBound(params)
			    ...
			    If u - l = 4 Then
				    ...
				    Else
					    v = params(i)(4)
				    End If
					'response.write params(i)(0)
					'response.write params(i)(1)
					'response.write params(i)(2)
					'response.write params(i)(3)
					'response.write v
					'response.end
